...
const handler = async (req, res)=>{
    if (req.method === "POST") {
        ...
        console.log(data);
        const clinet = await external_mongodb_namespaceObject.MongoClient.connect("mongodb+srv://suri:suri@myfirstcluster.qycng.mongodb.net/meetups?retryWrites=true&w=majority");
        const db = clinet.db();
